...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView ageTextview, @NonNull ImageView dogImageView,
      @NonNull TextView hobbiesTextview, @NonNull TextView nameTextview) {
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, ageTextview,
          dogImageView, hobbiesTextview, nameTextview);
    }
