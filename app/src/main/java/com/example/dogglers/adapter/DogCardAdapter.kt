...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val nameView: TextView = view!!.findViewById(R.id.name_textview)
        val ageView: TextView = view!!.findViewById(R.id.age_textview)
        val hobbiesView: TextView = view!!.findViewById(R.id.hobbies_textview)
    }
